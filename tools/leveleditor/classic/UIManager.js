...
export function UpdateMenuDisplay(block, world){
    function updateItemDisplay(item, side){
        ...
        if (item.id == 0){image.style.display = 'none';return;}
        switch (item.id){
            case 1:image.src = 'textures/tilesets/'+world+'/FIRE_TILE_1.png';break;
            case 2:image.src = 'textures/tilesets/'+world+'/ICE_TILE.png';break;
            case 3:image.src = 'textures/tilesets/'+world+'/INVISIBLE_TILE_1.png';break;
            case 4:image.src = 'textures/tilesets/'+world+'/ACID_TILE.png';break;
            case 7:image.src = 'textures/tilesets/'+world+'/EXIT_RED_TILE.png';break;
            case 8:image.src = 'textures/tilesets/'+world+'/TIMER_PAUSE_TILE.png';break;
            case 11:image.src = 'textures/tilesets/'+world+'/MOVING_SPIKE_TILE.png';break;
            case 12:image.src = 'textures/tilesets/'+world+'/SPIKE_TILE.png';break;
            default:image.src = 'sprites/'+item.id+ReturnItemValueName(item)+'.png';break;
        }
    ...
    function updateItemOptionsDisplay(){
        Array.from(document.getElementsByClassName('option')).forEach((element)=> {element.style.display = 'none';});
        let sideIndex;
        blockselects.forEach((element, index)=> {if (element.parentElement.childNodes[1].classList.contains('selected'))sideIndex = index;});
        switch (block.userData['type']){
            case 5:
                ...
                Array.from(document.getElementsByClassName('moving-option')).forEach((element)=> element.style.display = 'inline-block');
                break;
            case 7:
                editflashingindex.selectedIndex = block.userData['flashing'].index;
                Array.from(document.getElementsByClassName('flashing-option')).forEach((element)=> element.style.display = 'inline-block');
                break;
            case 8:
                console.log(block);
                ...
                Array.from(document.getElementsByClassName('laser-option')).forEach((element)=> element.style.display = 'inline-block');
        }
        ...
        if (block.userData['items'].length > 0 && sideIndex !== undefined){
            switch (block.userData['items'][sideIndex].id){
                case 5:
                    ...
                    edittransporterconnection.parentNode.children[1].children[0].src = 'sprites/5'+ReturnItemValueName(block.userData['items'][sideIndex])+'.png';
                    edittransportercolor.parentNode.children[1].children[0].src = 'sprites/5'+ReturnItemValueName(block.userData['items'][sideIndex])+'.png';
                    edittransporterenabled.parentNode.children[1].children[0].src = 'sprites/5'+ReturnItemValueName(block.userData['items'][sideIndex])+'.png';
                    edittransporterrotation.parentNode.children[1].children[0].src = 'sprites/5'+ReturnItemValueName(block.userData['items'][sideIndex])+'.png';
                    edittransporterpower.parentNode.children[1].children[0].src = 'sprites/5'+ReturnItemValueName(block.userData['items'][sideIndex])+'.png';
                    Array.from(document.getElementsByClassName('transporter-option')).forEach((element)=> element.style.display = 'inline-block');
                    break;
                case 9:
                    editbuttoncolor.value = block.userData['items'][sideIndex].varient;
                    editbuttonenabled.value = block.userData['items'][sideIndex].state;
                    editbuttoncolor.parentNode.children[1].children[0].src = 'sprites/9'+ReturnItemValueName(block.userData['items'][sideIndex])+'.png';
                    editbuttonenabled.parentNode.children[1].children[0].src = 'sprites/9'+ReturnItemValueName(block.userData['items'][sideIndex])+'.png';
                    editbuttonpower1.parentNode.children[1].children[0].src = 'sprites/9'+ReturnItemValueName(block.userData['items'][sideIndex])+'.png';
                    editbuttonpower2.parentNode.children[1].children[0].src = 'sprites/9'+ReturnItemValueName(block.userData['items'][sideIndex])+'.png';
                    Array.from(document.getElementsByClassName('button-option')).forEach((element)=> element.style.display = 'inline-block');
                    break;
                case 11:
                    editmovingspikeindex.value = block.userData['items'][sideIndex].varient;
                    Array.from(document.getElementsByClassName('moving-spike-option')).forEach((element)=> element.style.display = 'inline-block');
                    break;
                case 28:
                    ...
                    Array.from(document.getElementsByClassName('arrow-option')).forEach((element)=> element.style.display = 'inline-block');
                    break;
                case 30:
                    ...
                    Array.from(document.getElementsByClassName('player-spawn-option')).forEach((element)=> element.style.display = 'inline-block');
                    break;
                case 50:
                    ...
                    Array.from(document.getElementsByClassName('slow-star-option')).forEach((element)=> element.style.display = 'inline-block');
                    break;
                case 51:
                    ...
                    Array.from(document.getElementsByClassName('tire-option')).forEach((element)=> element.style.display = 'inline-block');
                    break;
                case 52:
                    ...
                    Array.from(document.getElementsByClassName('fast-star-option')).forEach((element)=> element.style.display = 'inline-block');
                    break;
                case 56:
                    editcaptivatorindex.value = block.userData['items'][sideIndex].varient;
                    Array.from(document.getElementsByClassName('captivator-option')).forEach((element)=> element.style.display = 'inline-block');
                    break;
            }
        }
    }
    ...
    switch (editblocktype.value){
        case '0':blockTexture = 'REGULAR_TILE_1.png';break;
        case '1':blockTexture = 'FIRE_TILE_1.png';break;
        case '2':blockTexture = 'ICE_TILE.png';break;
        case '3':blockTexture = 'INVISIBLE_TILE_1.png';break;
        case '4':blockTexture = 'ACID_TILE.png';break;
        case '5':blockTexture = 'MOVING_PLATFORM_TILE_4.png';break;
        case '6':blockTexture = 'CRUMBLE_TILE.png';break;
        case '7':blockTexture = 'REGULAR_TILE_1.png';break;
        case '8':
            switch (block.userData['laser'].color){
                case 0:blockTexture = 'LASER_YELLOW_TILE.png';break;
                case 1:blockTexture = 'LASER_BLUE_TILE.png';break;
                case 2:blockTexture = 'LASER_GREEN_TILE.png';break;
                case 3:blockTexture = 'LASER_RED_TILE.png';break;
                default:blockTexture = 'LASER_YELLOW_TILE.png';break;
            }
            break;
        default:blockTexture = 'REGULAR_TILE_1.png';break;
    }
    blocktype.children[1].style.backgroundImage = "url('./textures/tilesets/"+world+"/"+blockTexture+"')";
    for (let i = 0; i < blockgroup.children.length; i++)blockgroup.children[i].children[1].style.backgroundImage = "url('./textures/tilesets/"+world+"/"+blockTexture+"')";
    ...
    if (block.userData['type'] > 4)for (let i = 1; i < blocks.length; i++)blocks[i].style.display = 'none';
    else for (let i = 1; i < blocks.length; i++)blocks[i].style.display = 'inline-block';
    updateItemOptionsDisplay();
}

export function SetWorld(name){
    worlds.forEach((element)=> element.classList = '');
    document.getElementById(name).classList = 'selected';
}

export function SetSelectedBlockType(value){
    blocktypes.forEach((element)=> element.classList = '');
    blocktypes[value].classList = 'selected';
}

export function SetSelectedBoundType(value){
    boundtypes.forEach((element)=> element.classList = '');
    boundtypes[value].classList = 'selected';
}

export function DisplayAlert(type, message){
    if (currentTimeouts.length > 0)currentTimeouts.forEach((timeout)=> {if(timeout[0] == type)clearTimeout(timeout[1]);});
