...
export function InitializeTextures(worldName) {
  ...
  textureLoader.setPath("textures/tilesets/" + worldName + "/");
...
export function InitializeSkybox(scene, worldName) {
  scene.background = new THREE.CubeTextureLoader()
    .setPath("./textures/skyboxes/")
    .load([
      worldName + "/Positive Z.jpg",
      worldName + "/Negative Z.jpg",
      worldName + "/Positive Y.jpg",
      worldName + "/Negative Y.jpg",
      worldName + "/Negative X.jpg",
      worldName + "/Positive X.jpg",
    ]);
}
...
export function MapBlockTexture(block) {
  function CreateSideTexture(item) {
    switch (item.id) {
      case 1:
        return new THREE.MeshBasicMaterial({ map: FIRE_TILE_1 });
      case 2:
        return new THREE.MeshBasicMaterial({ map: ICE_TILE });
      case 3:
        ...
        return texture;
      case 4:
        return new THREE.MeshBasicMaterial({ map: ACID_TILE });
      case 5:
      case 9:
      case 10:
        return new THREE.MeshBasicMaterial({ map: ITEM_BASE_TILE });
      case 7:
        return new THREE.MeshBasicMaterial({ map: EXIT_RED_TILE });
      case 8:
        return new THREE.MeshBasicMaterial({ map: TIMER_PAUSE_TILE });
      case 11:
        return new THREE.MeshBasicMaterial({ map: MOVING_SPIKE_TILE });
      case 12:
        return new THREE.MeshBasicMaterial({ map: SPIKE_TILE });
      case 31:
      case 32:
      case 33:
      case 34:
      ...
      case 38:
        ...
        if (block.userData["type"] == 2)
          return new THREE.MeshBasicMaterial({ map: ICE_SHADOW_TILE });
        ...
        if (block.userData["type"] == 4)
          return new THREE.MeshBasicMaterial({ map: ACID_TILE });
        else return new THREE.MeshBasicMaterial({ map: SHADOW_TILE_1 });
      case 43:
      case 44:
      case 45:
      case 46:
      case 47:
        ...
        if (block.userData["type"] == 4)
          return new THREE.MeshBasicMaterial({ map: ACID_TILE });
        else return new THREE.MeshBasicMaterial({ map: SHADOW_TILE_2 });
      default:
        if (block.userData["type"] == 1)
          return new THREE.MeshBasicMaterial({ map: FIRE_TILE_1 });
        if (block.userData["type"] == 2)
        ...
        if (block.userData["type"] == 4)
          return new THREE.MeshBasicMaterial({ map: ACID_TILE });
        else return new THREE.MeshBasicMaterial({ map: REGULAR_TILE_1 });
    }
  }
  function MapMaterial(item) {
    if (item != undefined && item.id != 0 && item.id != 30)
      return CreateSideTexture(item);
    switch (block.userData["type"]) {
      case 0:
        switch (Math.floor(Math.random() * 4 + 1)) {
          case 1:
            return new THREE.MeshBasicMaterial({ map: REGULAR_TILE_1 });
          case 2:
            return new THREE.MeshBasicMaterial({ map: REGULAR_TILE_2 });
          case 3:
            return new THREE.MeshBasicMaterial({ map: REGULAR_TILE_3 });
          case 4:
            return new THREE.MeshBasicMaterial({ map: REGULAR_TILE_4 });
        }
      case 1:
        return new THREE.MeshBasicMaterial({ map: FIRE_TILE_1 });
      case 2:
      ...
      case 4:
        return new THREE.MeshBasicMaterial({ map: ACID_TILE });
      case 5:
        return new THREE.MeshBasicMaterial({ map: MOVING_PLATFORM_TILE_4 });
      case 6:
        return new THREE.MeshBasicMaterial({ map: CRUMBLE_TILE });
      case 7:
        switch (Math.floor(Math.random() * 4 + 1)) {
          case 1:
      ...
      case 8:
        return new THREE.MeshBasicMaterial({ map: LASER_YELLOW_TILE });
      default:
        return new THREE.MeshBasicMaterial({ map: REGULAR_TILE_1 });
    }
  }
  ...
  if (block.userData["laser"].swapped) {
    if (fromPosition.x != toPosition.x) {
      if (toPosition.x > fromPosition.x)
        return [
          new THREE.MeshBasicMaterial({ map: laserTexture }),
          new THREE.MeshBasicMaterial({ map: REGULAR_TILE_1 }),
          new THREE.MeshBasicMaterial({ map: REGULAR_TILE_1 }),
          new THREE.MeshBasicMaterial({ map: REGULAR_TILE_1 }),
          new THREE.MeshBasicMaterial({ map: REGULAR_TILE_1 }),
          new THREE.MeshBasicMaterial({ map: REGULAR_TILE_1 }),
